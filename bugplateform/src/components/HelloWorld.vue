          ...
          <el-row>
            <el-col span="24">
              <el-avatar size="100px"
                         src="http://localhost:8080/static/03b0d39583f48206768a7534e55bcpng.png"></el-avatar>
            </el-col>
          </el-row>
          <el-row>
            <el-col span="24">
        ...
        <el-main ref="main">
          <el-tabs v-model="editableTabsValue" type="card" closable @tab-remove="removeTab">
            ...
            >
              ...
              <iframe :src.sync="item.content" ref="iframe" style="width: 100%;" :height="frameHeight"
